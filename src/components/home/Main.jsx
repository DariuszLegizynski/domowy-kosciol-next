  ...
  return (
    <article className="relative grid grid-rows-[1fr_auto] w-full h-svh p-[0.4rem] overflow-hidden">
      ...
      <div className="grid grid-cols-[2rem_1fr_2rem] items-center justify-items-center">
        {isActive && <Link className="rotate-[270deg] translate-y-1" href="/fotogallery"><h3 className="before:content-['Zd'] before:text-black after:content-['jęcia'] after:text-white" /></Link>}
